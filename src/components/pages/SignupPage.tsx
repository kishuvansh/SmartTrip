...
export const SignupPage: React.FC = () => {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Let the auth listener in authStore handle state update
            navigate('/dashboard');
        } catch (error: any) {
            ...
            >
                <div className="bg-[#0A0F1C]/80 backdrop-blur-xl rounded-none border border-white/10 p-8 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="flex flex-col items-center mb-10">
                        ...
                        <h2 className="text-xl font-display font-medium text-white tracking-widest uppercase">Create Identity</h2>
                    </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-[10px] font-mono font-bold text-orbit-500 uppercase tracking-widest ml-1">Full Name</label>
                            <div className="relative group">
                                <User className="absolute left-4 top-3.5 text-orbit-500 group-focus-within:text-white transition-colors" size={16} />
                                <input
                                    type="text"
                                    required
                                    value={name}
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-mono font-bold text-orbit-500 uppercase tracking-widest ml-1">Confirm Token</label>
                            <div className="relative group">
                                <Lock className="absolute left-4 top-3.5 text-orbit-500 group-focus-within:text-white transition-colors" size={16} />
                                <input
                                    type="password"
                    ...
                    <div className="mt-6 text-center">
                        <Link to="/login" className="text-xs text-orbit-400 hover:text-white transition-colors">
